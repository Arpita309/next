...
var App = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(App, [{
    ...
    value: function componentDidMount() {
      ...
      _firebase_fire__WEBPACK_IMPORTED_MODULE_8__["auth"].onAuthStateChanged(function (user) {
        if (user) {
          console.log('user logged in: ', user);
          _firebase_fire__WEBPACK_IMPORTED_MODULE_8__["firestore"].collection('todos').get().then(function (querySnapshot) {
    ...
    value: function renderTodoList() {
      ...
      var ListItem = this.state.notes.map(function (todo, index) {
        return __jsx("div", {
...
//# sourceMappingURL=index.js.1e489a0db70189ecbf7a.hot-update.js.map