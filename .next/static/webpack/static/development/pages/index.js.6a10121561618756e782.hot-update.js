...
_firebase_fire__WEBPACK_IMPORTED_MODULE_10__["auth"].onAuthStateChanged(function (user) {
  if (user) {
    ...
    _firebase_fire__WEBPACK_IMPORTED_MODULE_10__["firestore"].collection('guides').get().then(function (querySnapshot) {
      var note = querySnapshot.docs.map(function (doc) {
        return doc.data();
      });
      console.log(note); //<div className="card border-success mb-3" style={{maxWidth: "20rem"}}>
      // <div className="card-body">
      // <h4 className="card-title">$(note.note)</h4>
      // </div>
      // </div>
    });
  } else {
...
//# sourceMappingURL=index.js.6a10121561618756e782.hot-update.js.map